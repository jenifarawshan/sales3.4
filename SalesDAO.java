...
public class SalesDAO {
    ...
    public void updateSales(String date, int productCode, int quantity) throws SQLException {
        PreparedStatement preparedStatement = connection.prepareStatement("UPDATE t_sales SET quantity=?, update_datetime=datetime('now') WHERE sales_date=? AND product_code=?");
